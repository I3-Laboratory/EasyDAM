...
import fppi_miss_
from cycle_about_function import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', type=str, default='./data_pseudo_cycle', help='Path to training set')
    ...
    parser.add_argument('--images', type=str, default='data_pseudo_cycle/tomato_project_f3_train/', help='path to images')
